...
class FFB3(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.frame_photo_4 = tk.PhotoImage(file=r'E:\USTH\Personal Fitness\FitnessProject\View\Image\Home page (noti off) (7).png')
        ...
        back_button = tk.Button(self, image=self.back_image, border=0, bg='#141414', activebackground='#141414',
                                command=lambda: [controller.show_frame('FFB2')])
        ...
        next_button = tk.Button(self, image=self.next_image, border=0, bg='#141414', activebackground='#141414',
                                command=lambda: [controller.show_frame('FFB4')])
